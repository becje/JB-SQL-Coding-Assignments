...
public class PeopleDao {
	...
	private final String GET_INDIVIDUAL_QUERY = "SELECT * FROM people WHERE people_id=?";
	...
	public People getPersonByID(int people_id) throws SQLException {
		//People individual = new People();
		PreparedStatement ps = connection.prepareStatement(GET_INDIVIDUAL_QUERY);
		ps.setInt(1, people_id);
		ResultSet rs = ps.executeQuery();
		rs.next();
		People indivdual = new People(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), rs.getString(10), rs.getString(11), rs.getString(12), rs.getString(13), rs.getString(14), rs.getString(15));
	...
	public void updateFamilyMemberName(int people_id, String firstName, String middleName, String lastName, String maidenName) throws SQLException {
		...
		ps.setString(4, maidenName);
		ps.setInt(5, people_id);
		ps.executeUpdate();
	}
