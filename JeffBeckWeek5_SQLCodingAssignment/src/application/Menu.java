...
public class Menu {
	...
	public void start() {
		...
		private void updateFamilyMemberName() throws SQLException {
			...
			if (people_id != null) {
				People currentIndv = peopleDao.getPersonByID(people_id);
				
				System.out.println("Please update the First Name or press enter to continue: ");
				String firstName = scanner.nextLine();
				if (firstName.isEmpty()) {
					System.out.println("First Name: " + firstName);
					firstName = currentIndv.getFirstName();
				}
				...
				if (maidenName.isEmpty()) {
					System.out.println("MaidenleName: " + maidenName);
					maidenName = currentIndv.getMaidenName();
				}
